<template>
  <div class="mx-auto text-normal relative">
    <div
    ...
    >
      <div
        class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 md:-translate-x-full py-8 px-6 w-[16.875rem] bg-white rounded-2xl"
      >
        ...
        <div class="flex items-center mb-1.5">
          ...
          <div class="text-[#707070] flex-1">Date</div>
          <div>
        ...
        <div class="flex items-center mb-1.5">
          ...
          <div class="text-[#707070] flex-1">Time</div>
          <div>
        ...
        <div class="flex items-center mb-1.5">
          ...
          <div class="text-[#707070] flex-1">Location</div>
        ...
        <div class="flex items-center mb-1.5">
          ...
          <div class="text-[#707070] flex-1">Organiser</div>
        ...
        <div class="flex items-center">
          ...
          <div class="text-[#707070] flex-1">Price</div>
          <div>{{ event.price }}</div>
        </div>
      </div>
    </div>
