<template>
  <div ref="container">
    ...
    <section
      ...
      ref="section_1"
    >
      <div class="absolute hidden md:block left-[50%] top-[50%] w-[50%] h-[50%]">
        <img
      ...
      >
        ...
        >{{ l("download").toUpperCase() }}</button>
      </app-link>
      <div class="flex-1"></div>
      <div class="w-[19.375rem] max-h-[30rem]">
        <img src="/images/sections/home-section-1/screenshot.png" />
      </div>
    </section>
    <section class="relative overflow-hidden h-[100vh]" ref="section_2">
      ...
      <div class="relative text-normal h-[100vh] flex flex-col pt-[7.25rem] md:pt-[4rem]">
        <div class="relative flex-1 md:h-[20%] w-full text-center">
          <h2
            ...
            ref="section2Text1"
          >{{ p("section_2_text_1") }}</h2>
          <h2
            class="absolute bottom-0 w-full whitespace-nowrap text-[3rem] md:text-[4.75rem] font-black leading-[1.15] opacity-0"
            ref="section2Text2"
          >{{ p("section_2_text_2") }}</h2>
          <h2
            class="absolute bottom-0 w-full whitespace-nowrap text-[3rem] md:text-[4.75rem] font-black leading-[1.15] opacity-0"
            ref="section2Text3"
          >{{ p("section_2_text_3") }}</h2>
        </div>

        <div ref="canvas_2" class="w-full h-auto max-w-[30rem] aspect-[640/858] mx-auto"></div>
      </div>
    </section>
    <section class="hidden md:block h-[100vh] bg-[#768797]" ref="section3md">
      <div class="overflow-hidden absolute w-full h-full" v-for="(card, i) in p('section_3_cards')">
        <div class="flex flex-col md:flex-row max-w-[70rem] mx-auto items-center w-full h-full">
          <div
            class="w-full md:w-[36%] md:max-w-[660px] flex-1 md:h-full flex justify-center items-center relative overflow-hidden order-6 md:order-1 mx-auto"
          >
            <div
              class="h-full md:h-auto md:w-full mx-auto px-6 py-[3rem] flex items-center opacity-0"
              ref="section3MdCovers"
            >
              <img class="block" :src="config.CDN_BASE + card.item.cover_md?.filename_disk" />
            </div>
          </div>
          <div
            class="w-full md:w-[64%] order-5 text-white flex flex-col pt-[6rem] md:pl-12 md:pr-6 px-6 md:pb-[9.875rem] md:py-0"
          >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img class="block" :src="config.CDN_BASE + card.item.cover?.filename_disk" />
          </div>
        </div>
        <div class="w-full md:w-[70%] order-5 text-white flex flex-col pt-[6rem] px-6 md:py-0">
    ...
    <section class="overflow-hidden relative h-[100vh] bg-[#000000]" ref="section_4">
      ...
      >
        <div class="mx-auto md:w-[37rem] px-[1.875rem] md:px-0 opacity-0" ref="section4Text">
          <h2
            class="text-[3rem] md:text-[4.75rem] font-black leading-[1.15] text-center md:text-left"
          >{{ p("section_4_title") }}</h2>
          <p class="text-[1.375rem] font-light mt-[2.5rem]">{{ p("section_4_content") }}</p>
          <div class="flex flex-col md:flex-row gap-6 md:gap-10 mt-6">
            ...
            >{{ p("section_4_btn_events") }}</app-link>
            <app-link
              to="lang-community"
              class="border-white hover:bg-white hover:text-black text-center border rounded-full p-3 text-[1.375rem] leading-none flex-1"
            >{{ p("section_4_btn_blog") }}</app-link>
          </div>
        </div>
      </div>
    </section>
    ...
    >
      <div class="text-black text-center" ref="section_5_container">
        ...
        >
          <h2
            class="text-[3rem] md:text-[4.75rem] font-black leading-[1.15]"
          >{{ p("section_5_title") }}</h2>
          <p class="text-[1.375rem] mt-5">{{ p("section_5_content") }}</p>
          <div class="mt-10">
...
const ld = `
  {
    ...
    "@graph": [
      {
        "@type": "WebSite",
        "@id": "https://www.beblu.com/#website",
        "url": "https://www.beblu.com/",
        "name": "Beblu",
        "description": "Work Smart Now",
        "inLanguage": "en-US"
      },
      {
        "@type": "ImageObject",
        "@id": "https://www.beblu.com/#primaryimage",
        "inLanguage": "en-US",
        "url": "https://www.beblu.com/images/thumbnail.jpg",
        "contentUrl": "https://www.beblu.com/images/thumbnail.jpg",
        "width": 1920,
        "height": 1080
      }
    ]
